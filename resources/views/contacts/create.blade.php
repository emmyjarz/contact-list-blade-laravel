    ...
    <form action="{{route('contacts.store')}}"method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="lastname" id="" placeholder="Required" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="">Email</label>
                    <input type="email" name="email" class="form-control" id="" placeholder="Required" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="">Phone</label>
                    <input type="tel" class="form-control" name="phone" id="" pattern="[0-9]{10}" placeholder="8007775555">
                </div>
                <div class="form-group col-md-4">
